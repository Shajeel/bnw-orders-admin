...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'flex font-medium rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-gray-200',
  };
